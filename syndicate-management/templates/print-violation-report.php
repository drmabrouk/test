...
<head>
    <meta charset="UTF-8">
    <title>تقرير مخالفات الأعضاء - <?php echo esc_html($syndicate['syndicate_name']); ?></title>
    ...
    <style>
        ...
        .syndicate-info h1 { margin: 0; font-size: 24px; font-weight: 900; }
        .syndicate-info p { margin: 5px 0 0 0; color: #666; font-size: 14px; }
...
<body onload="window.print()">
    ...
    <div class="header" style="border-bottom: 3px double #F63049; padding-bottom: 20px;">
        ...
        <div class="logo">
            <?php if (!empty($syndicate['syndicate_logo'])): ?>
                <img src="<?php echo esc_url($syndicate['syndicate_logo']); ?>" style="max-height: 100px; width: auto; display: block;" alt="Logo">
            <?php endif; ?>
        </div>
    </div>

    <div class="report-title">
        <h2>تقرير سجلات مخالفات الأعضاء</h2>
    </div>
    ...
    <div class="footer">
        <div>نظام إدارة النقابة - تم الاستخراج بواسطة: <?php echo wp_get_current_user()->display_name; ?></div>
        <div>صفحة 1 من 1</div>
    </div>
