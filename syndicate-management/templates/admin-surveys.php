        ...
        <div class="sm-modal-body">
            <div class="sm-form-group">
                ...
                <select id="survey_template_select" class="sm-select" onchange="smLoadSurveyTemplate(this.value)">
                    ...
                    <option value="academic_environment">استبيان البيئة المهنية والمرافق</option>
                </select>
            </div>
            <div class="sm-form-group">
...
const surveyTemplates = {
    'member_satisfaction': {
        ...
        questions: [
            'ما مدى رضاك عن نظافة المرافق النقابية؟',
            'هل تجد الوجبات النقابية متنوعة وصحية؟',
            'ما تقييمك لتوفر الأدوات في المختبرات العلمية؟',
            'هل تشعر بالأمان داخل مقر النقابة؟',
    ...
    'staff_feedback': {
        ...
        questions: [
            'مدى التزام عضو النقابة بالخطة المهنية المعتمدة؟',
            'استخدام الوسائل المهنية المبتكرة والذكية؟',
            'القدرة على إدارة الدرجة المهنية وتفاعل الأعضاء؟',
            'دقة وسرعة رصد تقييمات الأعضاء وتقييمهم؟',
            'التعاون مع الزملاء والإدارة النقابية؟'
        ]
    },
    'parent_engagement': {
        title: 'استبيان تواصل النقابة مع ولي الأمر',
        recipients: 'all',
        questions: [
            'ما مدى سهولة الوصول إلى تقارير سلوك العضو التابع لكم؟',
            'هل تجد تجاوباً سريعاً من عضو النقابة المهني؟',
    ...
    'academic_environment': {
        title: 'استبيان جودة البيئة المهنية',
        recipients: 'sm_syndicate_member',
        questions: [
            'توفر الموارد المهنية والكتب في الوقت المحدد؟',
            'مناسبة التجهيزات التقنية في القاعات المهنية؟',
            'كفاءة نظام رصد الغياب والحضور؟',
            'مدى وضوح اللائحة السلوكية وتطبيقها بعدالة؟',
            'رضاك العام عن بيئة العمل داخل النقابة؟'
        ]
    }
};
