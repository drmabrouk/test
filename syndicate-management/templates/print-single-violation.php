...
<head>
    <meta charset="UTF-8">
    <title>قرار انضباطي - <?php echo esc_html($record->member_name); ?></title>
    ...
    <style>
        ...
        .syndicate-title { font-weight: 700; font-size: 16px; color: #4A5568; margin-bottom: 15px; }
...
<body>
    ...
    <?php $syndicate = SM_Settings::get_syndicate_info(); ?>
    <div class="receipt">
        <div class="header">
            <div class="moe-title">وزارة التربية والتعليم – الإمارات العربية المتحدة</div>
            <div class="syndicate-title"><?php echo esc_html($syndicate['syndicate_name']); ?></div>
            <?php if (!empty($syndicate['syndicate_logo'])): ?>
                <img src="<?php echo esc_url($syndicate['syndicate_logo']); ?>" style="max-height: 100px; width: auto; object-fit: contain; display: block; margin: 10px auto;">
            <?php endif; ?>
        ...
        <div class="content-grid">
            <div class="row">
                <span class="label">اسم العضو:</span>
