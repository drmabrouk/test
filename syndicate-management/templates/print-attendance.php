...
<head>
    ...
    <style>
        ...
        .syndicate-info h1 { margin: 0; font-size: 1.5em; font-weight: 900; }
...
<body>
    ...
    foreach ($grouped_data as $scope_key => $members):
    ...
    <div class="grade-summary">
        <div class="print-header">
            <div class="syndicate-info">
                <?php if ($syndicate['syndicate_logo']): ?>
                    <img src="<?php echo esc_url($syndicate['syndicate_logo']); ?>" style="height: 50px; margin-bottom: 10px;">
                <?php endif; ?>
        ...
        <div class="report-meta">
            <span>عدد الأعضاء: <?php echo count($members); ?></span>
            <span>الحاضرين: <?php echo count(array_filter($members, function($s) { return $s->status == 'present'; })); ?></span>
            <span>الغائبين: <?php echo count(array_filter($members, function($s) { return $s->status == 'absent'; })); ?></span>
        </div>
        ...
        <table class="attendance-table">
            <thead>
                <tr>
                    ...
                    <th>كود العضو</th>
                    <th style="text-align: right;">اسم العضو</th>
                    <th>الحالة</th>
                    <th style="text-align: right;">ملاحظات</th>
                </tr>
            </thead>
            <tbody>
                <?php foreach ($members as $index => $s): ?>
                <tr>
                    <td><?php echo $index + 1; ?></td>
                    <td><?php echo esc_html($s->member_code); ?></td>
