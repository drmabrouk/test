...
<div class="sm-lesson-plans-container" dir="rtl">
    ...
    <div class="sm-card-grid" style="margin-bottom: 30px;">
        ...
        $staffs_count = count(get_users(array('role' => 'sm_syndicate_member')));
        ...
        <div class="sm-stat-card">
            <div style="font-size: 0.85em; color: var(--sm-text-gray); margin-bottom: 10px; font-weight: 700;">أعضاء النقابة قدموا هذا الأسبوع</div>
            <div style="font-size: 2em; font-weight: 900; color: var(--sm-primary-color);"><?php echo $uploaded_this_week; ?> / <?php echo $staffs_count; ?></div>
        </div>
    </div>
    <?php endif; ?>
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 30px;">
        ...
        <div style="display:flex; gap:10px;">
            <?php if ($is_officer || $is_syndicate_member || $is_admin): ?>
    ...
    <div class="sm-table-container">
        <table class="sm-table">
            ...
            <tbody>
                ...
                // Plans logic
                $plans = array();
                if ($is_syndicate_member || $is_officer || $is_admin) {
                ...
                <?php else: foreach($plans as $p): ?>
                    <tr>
                        ...
                        <td>
                            <?php if ($is_syndicate_member && $p->receiver_id == 0): ?>
...
<div id="add-plan-modal" class="sm-modal-overlay">
    <div class="sm-modal-content" style="max-width: 600px;">
        ...
        <form id="add-plan-form">
            ...
            <button type="submit" class="sm-btn">تقديم التحضير لمسؤول النقابة</button>
        </form>
    </div>
</div>
...
(function() {
    ...
    if (form) {
        form.addEventListener('submit', function(e) {
            ...
            formData.append('receiver_id', '0'); // 0 = Pending review by any staff
