...
$is_sys_manager = in_array('sm_system_admin', (array)$user->roles) || in_array('sm_manager', (array)$user->roles) || current_user_can('sm_full_access') || in_array('administrator', (array)$user->roles);
