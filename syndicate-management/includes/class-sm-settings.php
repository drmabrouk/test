    ...
    public static function get_hierarchical_violations() {
        $default = array(
            1 => array(
                ...
                '1.5' => array('name' => 'عدم إحضار الكتب أو الأدوات النقابية', 'points' => 1, 'action' => 'تنبيه شفوي'),
                ...
                '1.10' => array('name' => 'إهمال الواجبات النقابية المتكرر', 'points' => 2, 'action' => 'نصيحة تربوية'),
                '1.11' => array('name' => 'عدم اتباع تعليمات المناوبين في الساحة', 'points' => 2, 'action' => 'تنبيه شفوي'),
            ),
            2 => array(
                '2.1' => array('name' => 'الغياب عن النقابة بدون عذر مقبول', 'points' => 4, 'action' => 'إنذار خطي واستدعاء ولي أمر'),
                '2.2' => array('name' => 'الدخول أو الخروج من الفصل بدون استئذان', 'points' => 3, 'action' => 'إنذار خطي'),
                '2.3' => array('name' => 'عدم حضور الأنشطة النقابية الإلزامية', 'points' => 3, 'action' => 'إنذار خطي'),
                '2.4' => array('name' => 'التحريض على الشجار أو التخويف', 'points' => 5, 'action' => 'استدعاء ولي أمر وتعهد'),
                '2.5' => array('name' => 'مخالفة الزي التي تخدش قيم النقابة', 'points' => 4, 'action' => 'إنذار خطي وتغيير الملابس'),
            ...
            3 => array(
                ...
                '3.3' => array('name' => 'الهروب من النقابة أثناء الدوام الرسمي', 'points' => 12, 'action' => 'فصل مؤقت واستدعاء ولي أمر'),
                '3.6' => array('name' => 'العبث بممتلكات النقابة أو تخريبها', 'points' => 15, 'action' => 'دفع قيمة التلفيات وفصل مؤقت'),
                '3.7' => array('name' => 'تعريض سلامة الأعضاء أو الكادر للخطر', 'points' => 15, 'action' => 'مجلس انضباط وإيقاف عن الدراسة'),
                ...
                '3.10' => array('name' => 'التصوير داخل النقابة بدون إذن', 'points' => 10, 'action' => 'حذف المحتوى ومصادرة الهاتف'),
            ...
            4 => array(
                ...
                '4.5' => array('name' => 'التخريب العمدي للمرافق الحيوية بالنقابة', 'points' => 20, 'action' => 'تحميل التكاليف وفصل نهائي'),
                '4.6' => array('name' => 'الاعتداء الجسدي العنيف على الأعضاء أو الكادر', 'points' => 25, 'action' => 'إيقاف عن الدراسة وتصعيد قانوني'),
                ...
                '4.14' => array('name' => 'إشعال الحرائق عمدًا داخل حرم النقابة', 'points' => 30, 'action' => 'فصل نهائي وتحمل التبعات القانونية'),
            )
        );
